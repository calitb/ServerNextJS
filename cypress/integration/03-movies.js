  ...
  context('Desktop', () => {
    context('Content', () => {
      it('should display the cards', () => {
        ...
        // cy.get('[data-cy=nextmovies] > .flex-wrap #card-0 > .px-4 > .font-bold > [data-cy=date]').contains('viernes, 21 de julio de 2023 - 07:00 a. m.');
        ...
        cy.get('[data-cy=futuremovies] > .flex-wrap #card-0 > .px-4 > .font-bold > [data-cy=date]').contains('viernes, 21 de julio de 2023 - 07:00 a. m.');
        ...
        cy.get('[data-cy=futuremovies] > .flex-wrap #card-1 > .px-4 > .font-bold > [data-cy=date]').contains('domingo, 23 de julio de 2023 - 07:00 a. m.');
